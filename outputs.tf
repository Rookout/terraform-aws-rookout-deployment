output "controller_dns" {
  value       = var.datastore_acm_certificate_arn != "" && var.controller_acm_certificate_arn == "" || var.internal_controller_alb ? "Not Created" : var.controller_acm_certificate_arn == "" || var.internal && var.domain_name != "" ? "https://${aws_route53_record.controller[0].fqdn}" : "Please create CNAME record to endpoint with assosiated domain of certificate provided"
...
output "datastore_dns" {
  value       = var.deploy_datastore && var.domain_name != "" || var.deploy_datastore && var.internal && var.domain_name != "" ? "https://${aws_route53_record.datastore[0].fqdn}" : var.datastore_acm_certificate_arn == "" ? "Not Created" : "Please create CNAME record to endpoint with assosiated domain of certificate provided"
...
output "demo_dns" {
  value       = var.deploy_demo_app && var.domain_name != "" || var.deploy_demo_app && var.internal && var.domain_name != "" ? "https://${aws_route53_record.demo[0].fqdn}" : "Not Created"
